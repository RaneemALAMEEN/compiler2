...
public interface AngularParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 */
	T visitProgram(AngularParser.ProgramContext ctx) throws TypeMismatchException, VariableRedefinitionException, NgIfWithoutExpressionException, NgForOnNonIterableException;
	/**
	 * Visit a parse tree produced by {@link AngularParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStatement(AngularParser.StatementContext ctx) throws TypeMismatchException, VariableRedefinitionException, NgIfWithoutExpressionException, NgForOnNonIterableException;
	/**
	 * Visit a parse tree produced by {@link AngularParser#component}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitComponent(AngularParser.ComponentContext ctx) throws TypeMismatchException, VariableRedefinitionException, NgIfWithoutExpressionException, NgForOnNonIterableException;
	/**
	 * Visit a parse tree produced by {@link AngularParser#exportClass}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExportClass(AngularParser.ExportClassContext ctx) throws TypeMismatchException, VariableRedefinitionException;
	/**
	 * Visit a parse tree produced by {@link AngularParser#class}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass(AngularParser.ClassContext ctx) throws TypeMismatchException, VariableRedefinitionException;
	/**
	 * Visit a parse tree produced by {@link AngularParser#classBody}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassBody(AngularParser.ClassBodyContext ctx) throws TypeMismatchException, VariableRedefinitionException;
	/**
	 * Visit a parse tree produced by {@link AngularParser#decorator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDecorator(AngularParser.DecoratorContext ctx) throws NgIfWithoutExpressionException, NgForOnNonIterableException;
	/**
	 * Visit a parse tree produced by {@link AngularParser#argumentList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArgumentList(AngularParser.ArgumentListContext ctx) throws NgIfWithoutExpressionException, NgForOnNonIterableException;
	/**
	 * Visit a parse tree produced by {@link AngularParser#argument}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArgument(AngularParser.ArgumentContext ctx) throws NgForOnNonIterableException, NgIfWithoutExpressionException;
	/**
	 ...
	 * @return the visitor result
	 */
	T visitVariableDeclaration(AngularParser.VariableDeclarationContext ctx) throws VariableRedefinitionException;
	/**
	 * Visit a parse tree produced by {@link AngularParser#arrayDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArrayDeclaration(AngularParser.ArrayDeclarationContext ctx) throws TypeMismatchException;
	/**
